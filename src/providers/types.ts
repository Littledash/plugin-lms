...
export type Quiz = TypedCollection['quizzes'] & { lesson?: DefaultDocumentIDType | Lesson | null }
export type Certificate = TypedCollection['certificates']
export type Topic = TypedCollection['topics'] & { course?: DefaultDocumentIDType | Course | null }
