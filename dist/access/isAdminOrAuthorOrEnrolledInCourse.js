 ...
 */ export const isAdminOrAuthorOrEnrolledInCourse = async ({ req: { user, payload }, data })=>{
    if (user && checkRole([
        'admin',
        'author'
    ], user)) {
...
export const isAdminOrAuthorOrEnrolledInCourseFieldLevel = async ({ req: { user, payload }, doc })=>{
...
//# sourceMappingURL=isAdminOrAuthorOrEnrolledInCourse.js.map